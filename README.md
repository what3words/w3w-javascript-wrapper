# ![what3words](https://map.what3words.com/images/map/marker-border.png)w3w-javascript-wrapper ![Build Status](https://travis-ci.org/vicchi/w3w-javascript-wrapper.svg?branch=master)
